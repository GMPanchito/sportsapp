...
<body>
	...
	<article>
		...
		<div id="content">
			<div id="mision">
				<h3 class="header">¿Quienes somos?</h3>
				Una empresa centrada en el desarrollo de software para aplicaciones móviles en los diferentes sistemas operativos que existen en el mercado pero enfocada en Android. Estamos conscientes que nuestros clientes son todo para nuestra empresa es por ello que siempre buscamos su satisfacción al descargar y usar las aplicaciones que desarrollamos, ofreciéndoles una herramienta novedosa y útil en sus vidas. Nuestros productos van dirigidos a todas esas personas con acceso a las tecnologías actuales y en especial a los fanáticos de las aplicaciones móviles. 
				Nuestra empresa tiene la confianza en sí misma, por eso es que tratamos de hacer sentir al cliente en el mismo ambiente de confianza hacia nosotros, brindándoles calidad en el producto que adquieren. La empresa funciona a través del Director Ejecutivo, Analista, Diseñador y los Desarrolladores.
			</div>
			<div id="twitter">
